...
int main()
{
    ...
    for(int i = 0; i < 400; i++)
    {
        //runs all next100 programs and puts data into arrays 
        tableA.next100C(testDataA, insertAC, countA);
        tableA.next100Q(testDataA, insertAQ, countA);
        tableA.next100L(testDataA, insertAL, countA);

        //increments count by 100 to show that there are now count + 100 more new data entries
        countA = countA + 100;
        
        //runs all randSearch programs and puts data into arrays
        tableA.randSearchC(testDataA, searchAC, countA);
        tableA.randSearchL(testDataA, searchAL, countA);
        tableA.randSearchQ(testDataA, searchAQ, countA);
    }
    // cout << searchAQ[400] << endl;

    // A data insertion **************************************************************

    ofstream IAC;
    IAC.open("Hash_insert_AC.txt");
